...
import AddorEditExpenseCategory from '../Expenses/AddorEditExpenseCategory';
...
const ExpenseCategoriesTbl = () => {
    ...
    const record = expanseCategoryData.slice(frstIndex, lasIndex)
    const npage = Math.ceil(expanseCategoryData.length / rcrdprpg)
    ...
    const csvData = [
        ...
        ...expanseCategoryData.map(({ Username, Name, Role, Email }) => [
            Username,
            Name,
            Role,
            Email
    ...
    const displayData = () => {
        if (isAdd === true) {
            return <AddorEditExpenseCategory id={0} />
    ...
    useEffect(() => {
        ...
        const runDelete = () => {
            if (permission === true) {
                ...
                handleDeleteExpenseCategory(deleteId)
            }
        }
        runDelete()
        ...
        <div className='bg-white '>
            ...
            <div className='flex mt-5 flex-col md:flex-row  items-center justify-center md:justify-between mx-5'>
                ...
                <div className='flex items-center justify-center my-2 md:my-0'>
                    ...
                    <button onClick={() => { handleExportExcl(expanseCategoryData) }} className='flex border-[1px] px-2 py-1 hover:bg-gray-400 border-gray-600 bg-gray-200 '>
                            ...
                            return <tr key={index} className={`${(index + 1) % 2 === 0 ? "bg-gray-100" : ""}`}>
                                ...
                                {col3 && <td className='py-1 flex justify-center'>
                                    ...
                                    <button className='flex mx-3 p-1 items-center bg-red-600 text-white justify-center'>
                                        ...
                                        }} className='text-sm mx-1'>Delete</h1>
                                    </button>
...
export default ExpenseCategoriesTbl