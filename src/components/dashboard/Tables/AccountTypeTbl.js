...
const AccountTypeTbl = () => {
    ...
    const record = AccountTypesData.slice(frstIndex, lasIndex)
    const npage = Math.ceil(AccountTypesData.length / rcrdprpg)
    ...
    const csvData = [
        ...
        ...AccountTypesData.map(({ Username, Name, Role, Email }) => [
            Username,
            Name,
            Role,
            Email
        ...
        <div>
            ...
            <div className='flex mt-5 flex-col md:flex-row  items-center justify-center md:justify-between mx-5'>
                ...
                <div className='flex items-center justify-center my-2 md:my-0'>
                    ...
                    <button onClick={() => { handleExportExcl(AccountTypesData) }} className='flex border-[1px] px-2 py-1 hover:bg-gray-400 border-gray-600 bg-gray-200 '>
