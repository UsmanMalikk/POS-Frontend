    ...
    return (
        <div className='flex flex-col w-full px-3 bg-white '>
            ...
            <div className='flex flex-col mt-3'>
                ...
                <select type='text' value={formData.transferFrom} onChange={(e) => { setFormData({ ...formData, transferFrom: e.target.value }) }} placeholder='Transfer From' className='border-[1px] px-2 py-1 border-gray-400 focus:outline-none' >
            ...
            <div className='flex flex-col mt-3'>
                ...
                <select type='text' value={formData.transferTo} onChange={(e) => { setFormData({ ...formData, transferTo: e.target.value }) }} placeholder='Transfer To' className='border-[1px] px-2 py-1 border-gray-400 focus:outline-none' >
                    <option value={""}>Please Select</option>
                    {data.map((acc) => (
                        <option key={acc._id} value={acc._id}>
                            {acc.name}
