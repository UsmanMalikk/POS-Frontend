...
const BalanceSheet = () => {
    ...
    const findTotal = () => {
        let total = 0
        balanceSheetData.map(val => {
            return total += val.openingBalance    ////////ClosingStock and Customer due also should be added here
        })
        return total
    }
                    ...
                    <tbody>
                        <tr className='w-full'>
                            ...
                            <td>
                                ...
                                <table className='table-auto w-full'>
                                    <tbody>
                                    {balanceSheetData.map((sheet) => (

                                        <tr>
                                            <td className='text-start '>{sheet.name}</td>
                                            <td className='text-center '>₨ {sheet.openingBalance}</td>
                                        </tr>
                                        ))}
